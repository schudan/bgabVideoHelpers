...
?>
    ...
    <td><h2>5. Schritt</h2></td>
    <td><h2>6. Schritt</h2></td>
    </tr>
    <tr><td align='left' colspan="3" class='divider'>Diese Schritte werden im Internet blockiert, da Sicherheitsregeln eine Ausf&uuml;hrung verhindern - die Datei wird auf der Gemeinde Server korrekt erstellt - bringe alle erforderlichen Folien mit und speichere sie auf den Server. Dann kann eine Powerpointdatei erstellt. Die Datei findet man im Ordner Video/eventloop/sonntag mit dem Datum als Name: Jahr-Monat-Tag - z.B 20200531.pptx</td></tr>
    <tr  align='center'>
    <td><h3>Powerpoint Erzeugen</h3></td>
    <td><h3>Powerpoint downloaden</h3></td>
    <td><h3>Foyer 1 Video</h3></td>
    </tr>
    <tr align='center'><td>
    ...
    <td><form action="eventloop_video.php" method="get">
    <input type="submit" value="Video erstellen">
    </form>
		</td>
    </tr>
    </table>
