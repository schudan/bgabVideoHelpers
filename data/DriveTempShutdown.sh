...
#  echo 'Testing Drive sd'$i >>/home/keith/Desktop/Drives.Log
  ...
  then 
    ...
    then
      ...
      echo '============================' >>/home/keith/Desktop/Drives.Log
      echo '' >>/home/keith/Desktop/Drives.Log
      echo 'CRITICAL: TEMPERATURE FOR DRIVE sd'$i 'EXCEEDED' $2 '=>' $str2 'and shut down' >>/home/keith/Desktop/Drives.Log
      echo '' >>/home/keith/Desktop/Drives.Log
      echo '============================' >>/home/keith/Desktop/Drives.Log
      /sbin/shutdown -h now
      mail -s "Fileserver: CPU Warning" keithm107@bgab.de < /media/raid/data/myscripts/drivemsg.txt
      echo 'Email Sent.....'
      exit
    else
...
echo "JOB RUN AT $(date): All Drives are within limits" >>/home/keith/Desktop/Drives.Log
#echo ': All Drives are within limits' >>/home/keith/Desktop/Drives.Log
echo ''
